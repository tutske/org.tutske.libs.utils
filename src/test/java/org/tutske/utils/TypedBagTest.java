...
public class TypedBagTest {

	Key<String> key = new Key<> ("key");

	@Test
	public void it_should_known_when_it_contains_a_primary_value () {
	...
	@Test
	public void it_should_known_when_it_contains_a_secondary_value () {
		Bag<Key, String> bag = new Bag<Key, String> () {{
			add (key, "primary value", "secondary value");
		}};
	...
	@Test
	public void it_should_know_when_it_does_not_contain_a_value () {
		Bag<Key, String> bag = new Bag<Key, String> () {{
			add (key, "primary value", "secondary value");
		}};
	...
	@Test
	public void it_should_remember_multi_put_values () {
		Bag<Key, String> bag = new Bag<> ();
	...
	@Test
	public void it_should_remember_multiple_values_from_lists () {
		Bag<Key, String> bag = new Bag<> ();
	...
	@Test
	public void it_should_retain_the_newly_put_multiple_values () {
		Bag<Key, String> bag = new Bag<Key, String> () {{
			add (key, "old primary value");
		}};
	...
	@Test
	public void it_should_retain_the_old_primary_value_when_putting_multiple_values_on_a_key_with_a_value () {
		Bag<Key, String> bag = new Bag<Key, String> () {{
			add (key, "old primary value");
		}};
	...
	@Test
	public void it_should_forget_about_all_values () {
		Bag<Key, String> bag = new Bag<Key, String> () {{
			add (key, "primary");
		}};
	...
	@Test
	public void it_should_set_values_when_iterating_over_the_entries () {
		Bag<Key, String> bag = new Bag<Key, String> () {{
			add (key, "primary");
	...
	@Test
	public void it_should_set_values_of_secondary_values_when_iterating_over_entries () {
		Bag<Key, String> bag = new Bag<Key, String> () {{
	...
	@Test
	public void it_should_put_all_values_from_another_bag () {
	...
	@Test
	public void it_should_add_all_values_from_another_bag () {
		Key<String> first = new Key<> ("first");
		Key<String> second = new Key<> ("second");
		Key<String> third = new Key<> ("third");
	...
	@Test
	public void it_should_replace_all_values_from_another_bag () {
		Key<String> first = new Key<> ("first");
		Key<String> second = new Key<> ("second");
		Key<String> third = new Key<> ("third");
	...
	@Test
	public void it_should_squash_all_values_from_another_bag_into_the_current_one () {
		Key<String> first = new Key<> ("first");
		Key<String> second = new Key<> ("second");
		Key<String> third = new Key<> ("third");
