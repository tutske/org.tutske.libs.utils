...
public class ProgressBar {
	...
	public ProgressBar (String msg, int length) {
		this (System.out, msg, length);
	}

	public ProgressBar (PrintStream out, String msg, int length) {
		this.out = out;
		this.length = length;
		this.message = msg;
	}
	...
	public void showProgress (int current, int total) {
		...
		out.format ("\033[2K\r%1$6.2f %% " + GREEN.m ("%4$s") + " %2$s " + GREEN.m ("♦") + " %3$s",
